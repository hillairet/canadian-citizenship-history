...
function conflictData() {
  return [
    ...
    ["1813/10/26", "Lieutenant-Colonel Charles de Salaberry turns back 4000 American invaders at Chateauguay, South of Montreal"],
...
function legalData() {
  return [
    ...
    ["2006/11/27", "The House of Commons recognize that the Quebecois form a nation"],
  ]
}
...
function miscData() {
  return [
    ...
    ["1885/11/16", "Riel is executed after he was found guilty of treason despite the opposition of Quebec"],
    ...
    ["1960/06/22", "Beginning of the Quiet Revolution in Quebec: an era of rapid change."],
