...
function momentData() {
  return [
    ...
    ["1755/01/01", "Beginning of the Great Upheaval for Acadians that ends in 1763 with 2/3 of Acadians deported"],
    ...
    ["1814/10/01", "The Duke of Wellington sent some of his best soldiers to defend Canada.\n* He chose Ottawa (Bytown) as endpoint of Rideau Canal, the network of forst to prevent the US from invading Canada again."],
